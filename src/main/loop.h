...
#define LOOP
	...
	typedef enum CheatState CheatState;
	enum CheatState {FIRST_FORWARD, FIRST_BACKWARD, FIRST_RIGHT, CATCH_FORWARD, CLOSE_PINCE, CATCH_BACKWARD, DROP_RIGHT, DROP_FORWARD, DROP_OPEN, DROP_BACKWARD, CATCH_LEFT};
